...
Every sprite in this game is by **Aleksandr Makarov** — [@IknowKingRabbit](https://twitter.com/IknowKingRabbit),
[patreon.com/iknowkingrabbit](https://www.patreon.com/iknowkingrabbit).

The packs used are *HAS Buildings Pack*, *HAS Overworld Starter Pack*, and the
faction creature sets. `src/assets/sprites.png` is a curated subset of them,
...
The artist asked that this list travel with the work. It does.

*(Reproduced verbatim but for one repair: "Wendell Simões" reaches the source
file as `Sim├Áes`, a CP850 misreading of the UTF-8 `õ`. Publishing someone's name
mangled seemed worse than departing from a byte-exact copy.)*
...
Thank you for supporting. It's important to me especially at such a difficult time.
